...
public class DefaultFFMPEGLocator extends FFMPEGLocator {
    ...
    public DefaultFFMPEGLocator() {
        ...
        File ffmpegFile = new File("ffmpeg-" + arch +"-"+ MY_EXE_VERSION + suffix);
        ...
        if (ffmpegFile.exists()) {
            ...
            System.out.println("路径  ffmpeg-" + arch + suffix);
    ...
    private void copyFile(String path, File dest) {
        ...
        try {
            ...
            if (is == null) {
                ...
                //resourceName = "ws/schild/jave/nativebin/" + path; 原来的路径
                resourceName = "ws/schild/jave/native/" + path;
